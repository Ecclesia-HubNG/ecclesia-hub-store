...
const ALL_NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Deleted Orders',  href: '/admin/orders/deleted' },
    ],
  },
  {
    ...
    children: [
      { label: 'Shipping Zones',   href: '/admin/shipping',               exact: true },
      { label: 'Delivery Types',   href: '/admin/shipping/delivery-type' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Inventory Value',  href: '/admin/finance/inventory-value' },
    ],
  },
  {
