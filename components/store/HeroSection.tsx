  ...
  return (
    <section className="w-full px-3 md:px-5 pt-4 pb-10">
      <div className="relative overflow-hidden rounded-3xl min-h-[520px] md:min-h-[720px]">
        ...
        {/* Scrim — bottom-heavy so headline stays readable */}
        ...
        <div className="relative z-10 flex flex-col justify-between p-7 md:p-10 min-h-[520px] md:min-h-[720px]">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            {/* Top-right: glass product card (desktop) */}
            {featuredProduct && (
          ...
          <div className="flex items-end justify-between gap-6 flex-wrap md:flex-nowrap">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                <Link
                  href="/shop"
                  className="px-7 py-3 bg-white text-gray-900 text-sm font-bold rounded-full hover:bg-gray-100 transition-colors"
                >
                  Shop Now
                </Link>
                <Link
                  href="/shop"
                  className="px-7 py-3 bg-white/15 backdrop-blur-sm border border-white/30 text-white text-sm font-semibold rounded-full hover:bg-white/25 transition-colors"
                >
                  Explore More
                </Link>
              </div>
            ...
            {/* Bottom-right: white product card */}
