        ...
        {categories.map((cat, i) => {
          ...
          return (
            <Link
              ...
              className="group relative shrink-0 w-56 md:w-72 h-80 rounded-2xl overflow-hidden flex flex-col justify-between p-5 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
              {/* Background */}
              {cat.image ? (
                <>
