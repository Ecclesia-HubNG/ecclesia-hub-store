...
export default function Error({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 text-center">
      <p className="text-sm font-semibold uppercase tracking-widest text-[#4A0F1C] dark:text-[#E8C4CB] mb-4">Error</p>
      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Something went wrong</h1>
      <p className="text-gray-500 dark:text-gray-400 max-w-sm mb-8">
        We ran into an unexpected problem. Try again or head back to the shop.
      </p>
